...
class make_embedding(nn.Module):
    def __init__(
        ...
        #print("Spatial Pos: ", self.spatial_pos.shape)
        #print("Emb Spatial Size: ", emb_spatial_size)
        #print("D Size: ", d_size)
    ...
    def forward(self, x):
        ...
        #print("Pe_time: ", self.pe_time.shape)
        #print("Embedded space: ", embedded_space.shape)
