...
model_num = 1105262
run_specification = "vit_baseline"
...
modelpath = PATH + f"/../../models/vit_cmip6/vit_cmip6_{model_num}/"
...
print("Starting eval forward pass 3D-Geoformer")
with torch.no_grad():
    for i, batch in enumerate(val_dl_godas):
        ...
        pred_path = f'/mnt/qb/goswami/data/data_deeps2a_enso_paper/preds_xr_vit_{model_num}.zarr'
        targ_path = f'/mnt/qb/goswami/data/data_deeps2a_enso_paper/targets_xr_vit_{model_num}.zarr'
