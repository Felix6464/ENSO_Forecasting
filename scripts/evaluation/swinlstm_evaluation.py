...
datasets = ["godas", "cesm2_picontrol", "oras5", "cesm2_lens"] #"godas"
##datasets = ["cesm2_picontrol", "oras5", "cesm2_lens"]
#datasets = ["godas"]
#### CHECK BEFORE EXECUTING ####

model_num = 839388
run_specification = "seed8_rmse"
lens = True
model_path = 'best_oras5.pth'  #"best.pth" "cpkt.pth"
...
modelpath = PATH + f"/../../models/swinlstm_zhou/swinlstm_zhou_{model_num}/"
...
for dataset in datasets:
    ...
    with torch.no_grad():
        for i, batch in enumerate(val_dl):
            ...
            pred_path = f'/mnt/qb/goswami/data/data_deeps2a_enso/preds_xr_swinlstm_{model_num}_{dataset}.zarr'
            targ_path = f'/mnt/qb/goswami/data/data_deeps2a_enso/targets_xr_swinlstm_{model_num}_{dataset}.zarr'
    ...
    results_swinlstm = {"dataset" : dataset,
