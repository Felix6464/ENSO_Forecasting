...
cfg = {
    ...
    "model_dir" : PATH + "/../../models/swinlstm_zhou/",
    "decay" : False,
    "one_cycle_lr": True,
    "probabilistic": True,
    #training parameters
    "variable_loss_scaling": [1, 1, 1, 1, 1, 1, 1, 0.01, 0.01], #[1, 1, 1, 1, 1, 1, 1, 1, 1]
    "input_dim" : 9,
    "output_dim" : 9,
...
for current_epoch in range(num_epochs):
    ...
    mode = 'train'
    if cfg["nino_loss"]:
        #metric_logger = {f"rmse_avg": 0.0, f"crps_avg":0.0, f"loss_avg":0.0, f"mse_avg": 0.0, f"TFLOPS":0.0, f"batch_time": 0.0, f"nino_score": 0.0, f"nino_loss": 0.0}
        metric_logger = {f"rmse_avg": 0.0, f"crps_avg":0.0, f"loss_avg":0.0, f"mse_avg": 0.0, f"nino_score": 0.0, f"nino_loss": 0.0}
    else:
        #metric_logger = {f"rmse_avg": 0.0, f"crps_avg":0.0, f"loss_avg":0.0, f"mse_avg": 0.0, f"TFLOPS":0.0, f"batch_time": 0.0}
